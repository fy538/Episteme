...
import type { BackgroundActivity } from '@/lib/types/companion';
...
export function ReasoningCompanion({ threadId, caseId }: ReasoningCompanionProps) {
  const { reflection, backgroundActivity, currentTopic, isActive, error } = useReasoningCompanion(threadId);
  const [mode, setMode] = useState<VisibilityMode>('quiet');
  ...
  const widthClass = mode === 'quiet' ? 'w-52' : 'w-80';
  ...
  return (
    <>
      ...
      <div 
        ref={containerRef}
        className={cn(
          "border-l border-neutral-900/10 dark:border-neutral-100/10 bg-gradient-to-b from-neutral-50/80 to-white/80 dark:from-neutral-950/80 dark:to-neutral-900/80 backdrop-blur-xl transition-all duration-300",
          widthClass
        )}
      ...
      <div className="border-b border-neutral-900/5 dark:border-neutral-100/5 p-6 pb-5">
        <div className="flex items-center gap-2">
          <div className={cn(
            ...
            isActive ? "bg-primary-500 animate-pulse" : "bg-neutral-300"
          )} />
      ...
      <div className="overflow-y-auto max-h-[calc(100vh-200px)]">
        {mode === 'quiet' ? (
          ...
          <>
            ...
            {/* Bottom Section: Background Work */}
            {backgroundActivity && (
              <BackgroundSection 
