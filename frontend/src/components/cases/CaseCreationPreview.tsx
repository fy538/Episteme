    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4" onClick={onDismiss}>
      ...
      >
        ...
        <div className="p-6 border-b border-neutral-200">
          <h2 className="text-2xl font-bold text-neutral-900 mb-2">Create Decision Case</h2>
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-gray-800 leading-relaxed">{analysis.position_draft}</p>
            </div>
          </div>
              ...
              <div className="space-y-2">
                {analysis.assumptions.map((a, idx) => (
                  ...
                  >
                    ...
                    <span className="text-gray-800 flex-1">{a}</span>
                  </div>
                ))}
              </div>
              <p className="text-xs text-gray-500 mt-2">
        ...
        {/* Footer */}
        <div className="p-6 border-t border-neutral-200 bg-gray-50 flex items-center justify-between">
          <button
            onClick={onDismiss}
            disabled={isCreating}
