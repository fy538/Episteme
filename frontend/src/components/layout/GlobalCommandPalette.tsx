...
export function GlobalCommandPalette({ children }: GlobalCommandPaletteProps) {
  ...
  const commands: Command[] = [
    ...
    },
    {
      ...
      category: 'navigation',
      keywords: ['workspace', 'dashboard', 'cases', 'work'],
    ...
    },
    {
      ...
      category: 'navigation',
      keywords: ['cases', 'list', 'browse', 'all'],
      action: () => router.push('/workspace/cases'),
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      id: 'nav-inquiries-list',
      label: 'Browse All Inquiries',
      category: 'navigation',
      keywords: ['inquiries', 'research', 'list', 'browse', 'investigations'],
      action: () => router.push('/workspace/inquiries'),
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
