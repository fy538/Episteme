      ...
      <div className="relative bg-white rounded-lg shadow-2xl max-w-2xl w-full mx-4">
        ...
        <div className="border-b border-gray-200">
          <div className="flex items-center px-4 py-3">
            ...
            />
            <kbd className="hidden sm:inline-block px-2 py-1 text-xs font-medium text-gray-500 bg-gray-100 rounded">
              ESC
            </kbd>
          </div>
        </div>
              ...
              {filteredCommands.map((cmd, idx) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    {cmd.icon && <span className="text-gray-500">{cmd.icon}</span>}
