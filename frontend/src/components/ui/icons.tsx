...
//
// Every SVG icon used across the app lives here.
// Import what you need:
//   import { ChevronLeftIcon, TrashIcon } from '@/components/ui/icons';
// ═══════════════════════════════════════════════════════════════

export function CheckCircleSmall({ className }: { className?: string }) {
  return (
...
export function CircleSmall({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <circle cx="12" cy="12" r="10" />
    </svg>
...
export function EvolveIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
